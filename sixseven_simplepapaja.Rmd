...
#to do's: 
# caption tables (fix if too wide for page)
...
*      Across measures of quantity, utterance-type, object presence, and talker, nouns-per-minute were 2-5 times more frequent in videos than in audio-recordings 
...
apa_table(ages_table_data, caption = "Infant ages at recordings and lab visits", placement = "b")
```
...
apa_table(vars_with_NAs, caption = "Proportion of zero values", small = T)
```
