...
We assessed intercoder reliability on a random contiguous 10% of the annotations in each file. **add reliability stats**
...
#this first table needs to be fixed to account for S27 having no FAT (vars_with_NAs has already been fixed)
