...
We first assessed our 12 count measures across recording-types, examing
how noun input scaled between hour-long video-recordings and daylong
...
woke up, determining the exact onsets and offsets of daytime naps from
...
awake (i.e.~non-silent) time (Mode = 654 min., \emph{M} = 603min,
SD=106.8, R=385.2-951 min ). This comports with established norms for
...
across measures; see Table \ref{tab:vboost-table} \textbf{add SDs to
table}. Thus, by and large, videos had a denser concentration of nouns
