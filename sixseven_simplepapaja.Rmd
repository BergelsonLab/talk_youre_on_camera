...
```{r gr-derived-counts-67-diff, fig.cap = cap, echo = F, warning = F, fig.height=5, out.width="\\textwidth", fig.pos = "H", fig.align="center"}
...
```{r gr-derived-normcounts-diff, fig.cap = cap, echo = F, warning = F, fig.height = 4.5, out.width="\\textwidth", fig.pos = "H", fig.align="center"}
...
```{r gr-derived-normcounts-corr, fig.cap = cap, echo = F,  fig.height= 3, warning = F, out.width="\\textwidth", fig.pos = "H", fig.align="center"}
...
```{r gr-ut-count-collapsed, fig.cap = cap, echo = F,  fig.height = 3, fig.width = 3, warning = F, out.width="\\textwidth", fig.pos = "H", fig.align="center"}
...
```{r top-100-logspace, fig.cap = cap, echo = F, warning = F, message= F, fig.width = 9, fig.height = 7, out.width="\\textwidth", fig.pos = "H", fig.align="center"}
...
```{r top100-corr-rectype, fig.cap = cap, echo = F, fig.height = 2, fig.width = 2, out.width="\\textwidth", fig.pos = "H", fig.align="center"}
...
```{r top10noun-freq, fig.cap = cap, echo = F, warning = F, fig.height = 3, fig.width = 7, out.width="\\textwidth", fig.pos = "H", fig.align="center"}
