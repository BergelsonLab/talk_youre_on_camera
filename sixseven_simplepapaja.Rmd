...
#to do's: 
# format & caption tables (some are too wide)
# create figure legends
# fix figure/table rendering to be in situ and at the end
# check crossref's for figures and tables with \@ref(fig:chunk-name) for figures * \@ref(tab:chunk-name) for tables, bookdown style
# reliability stats
# change code to read in from blabr in sixseven_data_aggregation.R for both basic_level and basic_level_agg files
# check/fix/add refs (n.b.: multiple refs should be separated by ; not ,)
...
*      Across measures of quantity, utterance-type, referential transparency, and talker, nouns-per-minute were 2-5 times more frequent in videos than in audio-recordings 
