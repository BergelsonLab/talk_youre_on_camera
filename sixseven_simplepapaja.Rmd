...
cap <- "Utterance type proportions across audio-recordings (solid borders) and videos (dashed borders). Utterance types top to bottom are r: reading, s: singing, i: imperative, n: short phrase, q: questions, and d: declartives."
...
cap <- "Log-scaled counts of the top 100 words in audio and video recordings. Each node represents the averaged count, across all participants in both months, of a unique noun-token. Words that occured zero times in one recording-type are not shown."
