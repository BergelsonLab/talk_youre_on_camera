...
wsix1 <- wilcox.test(six_spreadAV_normmin$v_numtokens, six_spreadAV_normmin$a_numtokens,conf.int=T, paired = T)%>% tidy() %>% mutate(comp = "w6_numtok")
wsix2 <- wilcox.test(six_spreadAV_normmin$v_numtypes, six_spreadAV_normmin$a_numtypes,conf.int=T, paired = T)%>% tidy() %>% mutate(comp = "w6_numtyp")
wsix3 <- wilcox.test(six_spreadAV_normmin$v_numspeakers, six_spreadAV_normmin$a_numspeakers,conf.int=T, paired = T)%>% tidy() %>% mutate(comp = "w6_numsp")
wsix4 <- wilcox.test(six_spreadAV_normmin$v_MOT, six_spreadAV_normmin$a_MOT,conf.int=T, paired = T)%>% tidy() %>% mutate(comp = "w6_MOT")
wsix5 <- wilcox.test(six_spreadAV_normmin$v_FAT, six_spreadAV_normmin$a_FAT,conf.int=T, paired = T)%>% tidy() %>% mutate(comp = "w6_FAT")
wsix6 <- wilcox.test(six_spreadAV_normmin$v_d, six_spreadAV_normmin$a_d,conf.int=T, paired = T)%>%  tidy() %>% mutate(comp = "w6_d")
wsix7 <- wilcox.test(six_spreadAV_normmin$v_q, six_spreadAV_normmin$a_q,conf.int=T, paired = T)%>%  tidy() %>% mutate(comp = "w6_q")
wsix8 <- wilcox.test(six_spreadAV_normmin$v_r, six_spreadAV_normmin$a_r,conf.int=T, paired = T)%>%  tidy() %>% mutate(comp = "w6_r")
wsix9 <- wilcox.test(six_spreadAV_normmin$v_s, six_spreadAV_normmin$a_s,conf.int=T, paired = T)%>%  tidy() %>% mutate(comp = "w6_s")
wsix10 <- wilcox.test(six_spreadAV_normmin$v_i, six_spreadAV_normmin$a_i,conf.int=T, paired = T)%>%  tidy() %>% mutate(comp = "w6_i")
wsix11 <- wilcox.test(six_spreadAV_normmin$v_n, six_spreadAV_normmin$a_n,conf.int=T, paired = T)%>%  tidy() %>% mutate(comp = "w6_n")
wsix12 <- wilcox.test(six_spreadAV_normmin$v_y_op, six_spreadAV_normmin$a_y_op,conf.int=T, paired = T)%>%  tidy() %>% mutate(comp = "w6_yop")
...
wseven1 <- wilcox.test(sev_spreadAV_normmin$v_numtokens, sev_spreadAV_normmin$a_numtokens,conf.int=T, paired = T)%>% tidy() %>% mutate(comp = "w7_numtok")
wseven2 <- wilcox.test(sev_spreadAV_normmin$v_numtypes, sev_spreadAV_normmin$a_numtypes,conf.int=T, paired = T)%>% tidy() %>% mutate(comp = "w7_numtyp")
wseven3 <- wilcox.test(sev_spreadAV_normmin$v_numspeakers, sev_spreadAV_normmin$a_numspeakers,conf.int=T, paired = T)%>% tidy() %>% mutate(comp = "w7_numsp")
wseven4 <- wilcox.test(sev_spreadAV_normmin$v_MOT, sev_spreadAV_normmin$a_MOT,conf.int=T, paired = T)%>% tidy() %>% mutate(comp = "w7_MOT")
wseven5 <- wilcox.test(sev_spreadAV_normmin$v_FAT, sev_spreadAV_normmin$a_FAT,conf.int=T, paired = T)%>% tidy() %>% mutate(comp = "w7_FAT")
wseven6 <- wilcox.test(sev_spreadAV_normmin$v_d, sev_spreadAV_normmin$a_d,conf.int=T, paired = T)%>%  tidy() %>% mutate(comp = "w7_d")
wseven7 <- wilcox.test(sev_spreadAV_normmin$v_q, sev_spreadAV_normmin$a_q,conf.int=T, paired = T)%>%  tidy() %>% mutate(comp = "w7_q")
wseven8 <- wilcox.test(sev_spreadAV_normmin$v_r, sev_spreadAV_normmin$a_r,conf.int=T, paired = T)%>%  tidy() %>% mutate(comp = "w7_r")
wseven9 <- wilcox.test(sev_spreadAV_normmin$v_s, sev_spreadAV_normmin$a_s,conf.int=T, paired = T)%>%  tidy() %>% mutate(comp = "w7_s")
wseven10 <- wilcox.test(sev_spreadAV_normmin$v_i, sev_spreadAV_normmin$a_i,conf.int=T, paired = T)%>%  tidy() %>% mutate(comp = "w7_i")
wseven11 <- wilcox.test(sev_spreadAV_normmin$v_n, sev_spreadAV_normmin$a_n,conf.int=T, paired = T)%>%  tidy() %>% mutate(comp = "w7_n")
wseven12 <- wilcox.test(sev_spreadAV_normmin$v_y_op, sev_spreadAV_normmin$a_y_op,conf.int=T, paired = T)%>%  tidy() %>% mutate(comp = "w7_yop")
