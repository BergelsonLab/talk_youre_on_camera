...
most common audio-recording nouns were far more consistant across
...
developmental or linguistic milestones infants typically achieve at 6-7
months. We also normalized the count measures by recording length;
further details are below. While multi-level models with fixed effects
of recording-type and random subject-level effects were our initial
plan, nearly all such models revealed non-normal (generally
funnel-shaped) residuals, limiting interpretation across measures. This
was true even when we log-transformed the count data. We instead report
a simple set of nonparametric analyses below.
...
\section{eb got this far in the simpler
rewrite}\label{eb-got-this-far-in-the-simpler-rewrite}
...
language development (Bergelson \& Aslin, 2017; Bergelson \& Swingley
2013; Yurovsky et al, Brent \& Siskind, Swingley \& Humphrey, 2017;
Hoff-Ginsburg, 1985; Newport et al, 1977), these results present a clear
case where researchers would be led to different conclusions about
cross-month stability based on whether count- or proportion-based
analyses were used.
...
explain differences across studies (Barnes et al, 1983; see discussion
in Huttenlocher et al, 2002). Here we add the possibility that
recording-type too may contribute to the base-rates of questions in the
input, even with child-age kept relatively constant.
